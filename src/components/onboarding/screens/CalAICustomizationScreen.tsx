...
export default function CalAICustomizationScreen({ onNext }: OnboardingScreenProps) {
  return (
    <div className="bg-white rounded-2xl p-8 shadow-lg">
      ...
      >
        ...
        <p className="text-gray-600 mb-8">
          Set your preferences for notifications, privacy, and community participation
        </p>
