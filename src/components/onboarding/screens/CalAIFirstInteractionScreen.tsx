...
export default function CalAIFirstInteractionScreen({ onNext }: OnboardingScreenProps) {
  return (
    <div className="bg-white rounded-2xl p-8 shadow-lg">
      ...
      >
        ...
        <p className="text-gray-600 mb-8">
          Your complete recovery platform is ready with AI coach, community, and tools
        </p>
